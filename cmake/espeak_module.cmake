...
add_custom_command(
  ...
  COMMAND sh -c "${tools_dir}/make_espeakdata_module.sh ${PROJECT_SOURCE_DIR}/external/espeak/espeak-ng-data ${CMAKE_BINARY_DIR}/external/espeakdata_module ${PROJECT_BINARY_DIR}/espeakdata.tar.xz ${xz_path}"
